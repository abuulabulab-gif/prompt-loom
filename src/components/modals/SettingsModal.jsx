...
const GUIDE = (lang) => [
  {
    ...
    items: [
      ...
      { icon: '🎲', text: lang === 'ja' ? '「🎲おまかせ」ボタンでゼロからランダムキャラクターを自動生成（🧍キャラ特化/🖼️イラストの2モード）。ネガティブ・ロック済みブロックは対象外' : '"🎲 Random" auto-generates a character from scratch — two modes: 🧍 Char.Focused or 🖼️ Illust. Skips Negative and locked blocks' },
